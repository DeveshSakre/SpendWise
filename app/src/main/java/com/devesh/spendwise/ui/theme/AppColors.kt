package com.devesh.spendwise.ui.theme

import androidx.compose.ui.graphics.Color

object AppTextColor {
    val Primary = Color(0xFF1B1B23)
    val Secondary = Color(0xFF464555)
    val Hint = Color(0xFF767586)
}
...
object StitchColors {
    ...
    val SurfaceContainer = Color(0xFFEFECF9)
    val SurfaceContainerHigh = Color(0xFFE9E6F3)
